...
module.exports = "<div *ngIf=\"done\">\r\n  <div *ngFor=\"let update of Webhooks.updates\">\r\n    <div style=\"border-bottom: 1px solid\">\r\n      <span style=\"font-size: 14pt\">{{update.head_commit.timestamp}}</span>\r\n      <br>\r\n      <b style=\"font-size: 16pt\">\r\n        <img [src]=\"update.sender.avatar_url\" width=\"20px\" style=\"border: 1px solid white; border-radius: 2px; margin-top: 2px\"> {{update.pusher.name}}</b>\r\n      <br>\r\n      <a [href]=\"update.head_commit.url\" target=\"_blank\">{{update.head_commit.id}}</a>\r\n      <br>\r\n      <code>{{update.head_commit.message}}</code>\r\n    </div>\r\n  </div>\r\n</div>"
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["b" /* HttpClientModule */]],
